...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class ConventionPropertyExtensions
    {
        ...
        /// <summary>
        ///     Gets the <see cref="ConfigurationSource" /> for <see cref="PropertyExtensions.FindTypeMapping(IReadOnlyProperty)" />.
        /// </summary>
        /// <param name="property"> The property. </param>
        /// <returns> The <see cref="ConfigurationSource" /> for <see cref="PropertyExtensions.FindTypeMapping(IReadOnlyProperty)" />. </returns>
