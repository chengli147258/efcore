...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    ...
    public class Model : ConventionAnnotatable, IMutableModel, IConventionModel, IModel
    {
        ...
        public virtual IModel FinalizeModel()
        {
            ...
            IReadOnlyModel finalizedModel = ConventionDispatcher.OnModelFinalizing(Builder).Metadata;
            finalizedModel = ConventionDispatcher.OnModelFinalized(finalizedModel);

            return (finalizedModel as Model)?.MakeReadonly() ?? (IModel)finalizedModel;
        }
